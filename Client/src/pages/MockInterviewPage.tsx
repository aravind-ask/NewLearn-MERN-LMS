...
import { MarqueImg } from "@/components/common/marquee-img";
import hero from "@/assets/images/hero.jpg";
import firebase from "@/assets/logo/firebase.png";
import meet from "@/assets/logo/meet.png";
    ...
    <div className="flex-col w-full pb-24">
      ...
      <div className=" w-full my-12">
        <Marquee pauseOnHover>
          <MarqueImg img={firebase} />
          <MarqueImg img={meet} />
          <MarqueImg img={zoom} />
          <MarqueImg img={firebase} />
          <MarqueImg img={microsoft} />
          <MarqueImg img={meet} />
          <MarqueImg img={tailwind} />
          <MarqueImg img={microsoft} />
        </Marquee>
      </div>
